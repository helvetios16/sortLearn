        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="bg-slate-50 border-2 border-slate-200 rounded-xl shadow-lg p-4">
            ...
            <div class="memory-viz mb-3">
              ...
              <div class="memory-array">
                ...
                >
                  ...
                  <div class="mem-label" v-if="idx === currentIteration">i</div>
                  <div class="mem-label mem-label-j" v-if="idx === expectedNextComparison.right && idx > currentIteration">j</div>
                </div>
              </div>
            </div>
            ...
            <div class="algorithm-state mb-3">
              <div class="state-indicator" :class="algorithmState">
                <span class="state-icon">{{ stateIcon }}</span>
                <span class="state-text">{{ stateDescription }}</span>
              </div>
              <div class="loop-info" v-if="currentIteration < totalIterations">
                <div class="loop-row">
                ...
                <div class="loop-row">
                  ...
                  <span class="loop-value comparison-hint">arr[{{ expectedNextComparison.left }}] vs arr[{{ expectedNextComparison.right }}]</span>
                </div>
              </div>
            </div>
